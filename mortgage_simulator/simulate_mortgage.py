...
def simulate_mortgage(
    ...
    simulation_by_payment = mutuo.simulate_by_payment(monthly_payment, title="monthly payment")
    simulations.add_simulation(simulation_by_payment)

    simulation_by_minimum_payment = mutuo.simulate_by_payment(mutuo.minimum_monthly_payment, title="minimum payment")
